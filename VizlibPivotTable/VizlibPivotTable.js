...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibPivotTable': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibPivotTable&version=auto&end', '/extensions/VizlibPivotTable/resources/vizliberror']
  }
});

define(['vzb_VizlibPivotTable'],function(vizlib){
	return vizlib;
});
