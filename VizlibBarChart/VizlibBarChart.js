...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibBarChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibBarChart&version=auto&end', '/extensions/VizlibBarChart/resources/vizliberror']
  }
});

define(['vzb_VizlibBarChart'],function(vizlib){
	return vizlib;
});
