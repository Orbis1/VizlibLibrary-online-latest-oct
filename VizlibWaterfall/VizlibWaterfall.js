...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibWaterfall': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibWaterfall&version=auto&end', '/extensions/VizlibWaterfall/resources/vizliberror']
  }
});

define(['vzb_VizlibWaterfall'],function(vizlib){
	return vizlib;
});
