...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibCalendar': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibCalendar&version=auto&end', '/extensions/VizlibCalendar/resources/vizliberror']
  }
});

define(['vzb_VizlibCalendar'],function(vizlib){
	return vizlib;
});
