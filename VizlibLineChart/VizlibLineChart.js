...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibLineChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibLineChart&version=auto&end', '/extensions/VizlibLineChart/resources/vizliberror']
  }
});

define(['vzb_VizlibLineChart'],function(vizlib){
	return vizlib;
});
