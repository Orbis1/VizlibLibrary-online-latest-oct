...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibLineObject': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibLineObject&version=auto&end', '/extensions/VizlibLineObject/resources/vizliberror']
  }
});

define(['vzb_VizlibLineObject'],function(vizlib){
	return vizlib;
});
