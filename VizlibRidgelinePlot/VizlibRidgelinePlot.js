...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibRidgelinePlot': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibRidgelinePlot&version=auto&end', '/extensions/VizlibRidgelinePlot/resources/vizliberror']
  }
});

define(['vzb_VizlibRidgelinePlot'],function(vizlib){
	return vizlib;
});
