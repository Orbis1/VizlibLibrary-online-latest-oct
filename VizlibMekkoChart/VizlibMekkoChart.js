...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibMekkoChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibMekkoChart&version=auto&end', '/extensions/VizlibMekkoChart/resources/vizliberror']
  }
});

define(['vzb_VizlibMekkoChart'],function(vizlib){
	return vizlib;
});
