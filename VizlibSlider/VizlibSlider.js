...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibSlider': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibSlider&version=auto&end', '/extensions/VizlibSlider/resources/vizliberror']
  }
});

define(['vzb_VizlibSlider'],function(vizlib){
	return vizlib;
});
