...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibSheetMenuPlus': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibSheetMenuPlus&version=auto&end', '/extensions/VizlibSheetMenuPlus/resources/vizliberror']
  }
});

define(['vzb_VizlibSheetMenuPlus'],function(vizlib){
	return vizlib;
});
