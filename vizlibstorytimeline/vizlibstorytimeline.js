...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_vizlibstorytimeline': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=vizlibstorytimeline&version=auto&end', '/extensions/vizlibstorytimeline/resources/vizliberror']
  }
});

define(['vzb_vizlibstorytimeline'],function(vizlib){
	return vizlib;
});
