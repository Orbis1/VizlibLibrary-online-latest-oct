...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibContainer': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibContainer&version=auto&end', '/extensions/VizlibContainer/resources/vizliberror']
  }
});

define(['vzb_VizlibContainer'],function(vizlib){
	return vizlib;
});
