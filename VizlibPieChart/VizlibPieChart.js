...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibPieChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibPieChart&version=auto&end', '/extensions/VizlibPieChart/resources/vizliberror']
  }
});

define(['vzb_VizlibPieChart'],function(vizlib){
	return vizlib;
});
