...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibGridChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibGridChart&version=auto&end', '/extensions/VizlibGridChart/resources/vizliberror']
  }
});

define(['vzb_VizlibGridChart'],function(vizlib){
	return vizlib;
});
