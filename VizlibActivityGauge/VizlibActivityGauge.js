...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibActivityGauge': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibActivityGauge&version=auto&end', '/extensions/VizlibActivityGauge/resources/vizliberror']
  }
});

define(['vzb_VizlibActivityGauge'],function(vizlib){
	return vizlib;
});
