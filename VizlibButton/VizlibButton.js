...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibButton': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibButton&version=auto&end', '/extensions/VizlibButton/resources/vizliberror']
  }
});

define(['vzb_VizlibButton'],function(vizlib){
	return vizlib;
});
