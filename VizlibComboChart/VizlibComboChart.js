...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibComboChart': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibComboChart&version=auto&end', '/extensions/VizlibComboChart/resources/vizliberror']
  }
});

define(['vzb_VizlibComboChart'],function(vizlib){
	return vizlib;
});
