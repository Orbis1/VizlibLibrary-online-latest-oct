...
requirejs.config({
  waitSeconds: 0,
  paths: {
    'vzb_VizlibSwitch': ['https://bouncer.vizlib.com/get?key=4910527-8088de0-a23aab0-0eace80&type=js&extension=VizlibSwitch&version=auto&end', '/extensions/VizlibSwitch/resources/vizliberror']
  }
});

define(['vzb_VizlibSwitch'],function(vizlib){
	return vizlib;
});
